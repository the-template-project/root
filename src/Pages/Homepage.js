  ...
  return (
    <div>
      ...
      <Carousel
        itemsPerPage={6}
      >
        <img style={{'width': '50px', 'height': '50px'}} src={fbIcon} alt='fbIcon'/>
        <img style={{'width': '200px', 'height': '200px'}} src={twitterIcon} alt='twitterIcon'/>
        <img style={style} src={antonJansson} alt='antonJansson'/>
        <img style={style} src={bennMcGuinness} alt='bennMcGuinness'/>
        <img style={style} src={hiepDuong} alt='hiepDuong'/>
        <img style={style} src={nathanAnderson} alt='nathanAnderson'/>
        <img style={style} src={thomanBennie} alt='thomanBennie'/>
        <img style={style} src={unitedNations} alt='unitedNations'/>
      </Carousel>
    </div>
  );
}
